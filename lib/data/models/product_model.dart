...
final List<ProductModel> sampleProducts = [
  ...
  ProductModel(
    ...
    description:
        'iPhone 15 brings Dynamic Island, a 48MP main camera, and USB-C to the mainstream lineup.',
  ...
  ProductModel(
    ...
    description:
        'iPad Pro with M2 chip and Liquid Retina XDR display — the ultimate iPad experience.',
  ...
  ProductModel(
    ...
    storage: ['32GB'],
    description:
        'Apple Watch Series 9 with the new S9 chip, Double Tap gesture, and brighter Always-On display.',
  ...
  ProductModel(
    ...
    storage: ['N/A'],
    description:
        'AirPods Pro 2 with H2 chip deliver up to 2x more ANC, Adaptive Audio, and Personalized Spatial Audio.',
    displaySpec: 'N/A',
    cameraSpec: 'N/A',
  ...
  ProductModel(
    ...
    storage: ['256GB', '512GB', '1TB'],
    description:
        'Galaxy Tab S9 Ultra with a stunning 14.6" Dynamic AMOLED 2X display and built-in S Pen.',
  ...
  ProductModel(
    ...
    storage: ['16GB'],
    description:
        'Galaxy Watch 6 Classic brings back the iconic rotating bezel with advanced health tracking and Wear OS.',
  ...
  ProductModel(
    ...
    storage: ['N/A'],
    description:
        'Galaxy Buds 2 Pro with 24-bit Hi-Fi audio, intelligent ANC, and IPX7 water resistance.',
    displaySpec: 'N/A',
    cameraSpec: 'N/A',
  ...
  ProductModel(
    ...
    storage: ['N/A'],
    description:
        'Xiaomi Watch S3 with HyperOS, AMOLED display, and up to 15-day battery life.',
  ...
  ProductModel(
    ...
    storage: ['N/A'],
    description:
        'Xiaomi Buds 4 Pro with Adaptive ANC 2.0, LDAC hi-res audio, and 9-hour playback.',
    displaySpec: 'N/A',
    cameraSpec: 'N/A',
  ...
  ProductModel(
    ...
    storage: ['256GB', '512GB'],
    description:
        'OPPO Find X7 Ultra features Hasselblad quad cameras, Snapdragon 8 Gen 3, and 100W SUPERVOOC charging.',
  ...
  ProductModel(
    ...
    storage: ['N/A'],
    description:
        'OPPO Watch X with Snapdragon W5 chip, Dual OS support, and AMOLED display.',
    displaySpec: '1.43" AMOLED, 466x466, Always-On',
    cameraSpec: 'N/A',
  ...
  ProductModel(
    ...
    storage: ['N/A'],
    description:
        'OPPO Enco X2 co-engineered with Dynaudio for studio-grade sound with Adaptive ANC.',
    displaySpec: 'N/A',
    cameraSpec: 'N/A',
